...
import { IndianRupee, Download, Calendar, TrendingUp, Users, Wallet, Search, Building2, ChevronRight, ChevronDown, User as UserIcon, Mail } from "lucide-react";
...
export default function PayrollReportPage() {
  ...
  const handleSendMail = () => {
    toast({ title: "Email Sent", description: "Payroll report has been sent to administrators." });
  };
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold text-slate-900" data-testid="text-page-title">Unit-wise Payroll Reports</h1>
